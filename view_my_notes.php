   ...
   <body onload="appointment()">
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-md-10">
               <div class="btn-group">
                  <button type="button" class="btn btn-success" onclick="appointment()">Appointment</button>
                  <button type="button" class="btn btn-info" onclick="meeting()">Meeting</button>
                  <button type="button" class="btn btn-danger" onclick="event_rm()">Event</button>
                  <button type="button" class="btn btn-primary" onclick="birthday()">Birthday</button>
                  <button type="button" class="btn btn-warning" onclick="memory()">Memory</button>
                  <button type="button" class="btn btn-success" onclick="reminder()">Reminder</button>
               </div>
            </div>
         </div>
      ...
      <script type="text/javascript">
         function appointment()
        {
                  ...
                  xhttp.open("GET","showtable.php?type="+a,true);
                  xhttp.send();
               }
               function meeting()
               {
