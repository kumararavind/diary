...
<html lang="zxx">
   ...
   $id=$_GET['uid'];
   $query=mysqli_query($con,"SELECT * from meeting where uid='$id'")or die(mysqli_error($con));
    ...
    <form action="" method="POST">
      <div class="row">
         <div class="col-md-6 form-group">
            ...
            <input type="text" name="mdate" class="form-control" placeholder="Enter Meeting Date" value="<?php echo $row['mdate']; ?>">
         </div>   
         <div class="col-md-6 form-group">
            <label>Meeting With</label>
            <input type="text" name="mwith" class="form-control" placeholder="Enter Meeting With" value="<?php echo $row['mwith']; ?>">
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-md-6 form-group">
            ...
            <input type="text" class="form-control" name="reason" placeholder="Enter Meeting Reason" value="<?php echo $row['reason']; ?>">
         </div>
         <div class="col-md-6 form-group">
...
<?php
   if(isset($_POST['submit']))
   {
      ...
      $query=mysqli_query($con,"UPDATE `meeting` SET `mwith`='$mwith',`reason`='$reason',`mdate`='$mdate',`postedon`='$postedon',`mstatus`='$mstatus' WHERE uid='$id'") or die(mysqli_error($con));
       if($query==true)
         {
