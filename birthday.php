...
<?php include "connection.php";
   $id=$_GET['uid'];
   $query=mysqli_query($con,"SELECT * from birthday where uid='$id'")or die(mysqli_error($con));
    ...
    <form action="" method="POST">
      <div class="row">
         <div class="col-md-6 form-group">
            ...
            <input type="text" name="bdate" class="form-control" placeholder="Enter Birthday Date" value="<?php echo $row['bdate']; ?>">
         </div>   
         <div class="col-md-6 form-group">
            <label>Birthday Name</label>
            <input type="text" name="bname" class="form-control" placeholder="Enter Birthday With" value="<?php echo $row['bname']; ?>">
         </div>
      </div>
        <div class="row">
            <div class="col-md-6 form-group">
...
<?php
   if(isset($_POST['submit']))
   {
      ...
      $query=mysqli_query($con,"UPDATE `birthday` SET `bdate`='$bdate',`bname`='$bname',`bstatus`=''$bstatus,`postedon`='$postedon' WHERE uid='$id'") or die(mysqli_error($con));
       if($query==true)
         {
