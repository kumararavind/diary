      ...
      <div class="header-main" id="home">
         <div class="header-outs">
            <div class="header-bar">
               <h1><a href="index.html">PERSONOTE</a></h1>
            </div>
            ...
            <div class="menu">
               ...
               <nav>  
                  ...
                  <a href="login/index.php">SignIn</a>  
         ...
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            <div class="row agile-abt-info ">
               <div class="col-lg-6 col-md-6 w3layouts-left-side-img">
                  <img src="/images/ab1.zip" alt="" class="img-fluid">
               </div>
               <div class="col-lg-6 col-md-6 info-sub-w3 pb-lg-3 pb-md-2 pb-2">
                  <div class="jst-wthree-text pb-3">
                     <h2>Welcome To NoteDownMe
                     </h2>
                     <p>A diary is a record with discrete entries arranged by date reporting on what has happened over the course of a day or other period.<br></p>
                  </div>
                     ...
                     <div class="latest-blog">
                        <div class = " tabs-menu-grid">
                           <div class="grid-hover">
                              <a href = "blog.html" class = "column "><span class = "text">Pizza</span><img src="images/g1.jpg" alt="img04" class="img-fluid"></a>
                           </div>
                           <div class=" grid-hover">
                              <a href = "blog.html" class = "column "><span class = "text">Pizza</span><img src="images/g2.jpg" alt="img04" class="img-fluid"></a>
                           </div>
                           <div class="grid-hover">
                              <a href = "blog.html" class = "column "><span class = "text">Pizza</span><img src="images/g3.jpg" alt="img04" class="img-fluid"></a>
                           </div>
                           <div class="grid-hover ">
                              <a href = "blog.html" class = "column "><span class = "text">Pizza</span><img src="images/g4.jpg" alt="img04" class="img-fluid"></a>
                           </div>
                        </div>
                        <div class = "tabs-menu-grid">
                           <div class="grid-hover">
         ...
         <div class="container pt-lg-5 pt-md-5 pt-sm-4 pt-4">
            <div class="row footer-agile-grids ">
               <div class="col-lg-6 col-md-12 wthree-left-right">
                  <div class="row">
                     <div class="col-md-5 footer-header pl-0">
                        <h5><a href="index.php">PERSONOTE</a></h5>
                        <p>PERSONAL LIFE IS SPECIAL(^_^)</p>
                     </div>
                     <div class="col-md-7 footer-para">
                        <p>BNJ Apartment,<br>Kodialbail,Mangalore.</p>
                        <p>+91 7406350826</p>
                        <p>+91 7204714302</p>
                        <p><a href="mailto:info@example.com">aravindkumar8792@gmail.com</a></p>
                     </div>
                  </div>
               </div>
