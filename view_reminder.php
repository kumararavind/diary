...
<html lang="zxx">
  ...
  <?php include "connection.php";
   $id=$_GET['uid'];
   $query=mysqli_query($con,"SELECT * from reminder where uid='$id'")or die(mysqli_error($con));
    ...
    <form action="" method="POST">
      <div class="row">
         <div class="col-md-6 form-group">
            ...
            <input type="text" name="storedon" class="form-control" placeholder="Enter Reminder Date" value="<?php echo $row['storedon']; ?>">
         </div>   
         <div class="col-md-6 form-group">
            <label>Stuff Name</label>
            <input type="text" name="thingname" class="form-control" placeholder="Enter Stuff Name" value="<?php echo $row['thingname']; ?>">
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-md-6 form-group">
            ...
            <input type="text" class="form-control" name="storage" placeholder="Enter Stored Place" value="<?php echo $row['storage']; ?>">
         </div>
         <div class="col-md-6 form-group">
...
<?php
   ...
   {
      $storedon=$_POST['storedon'];
      $thingname=$_POST['thingname'];
      $storage=$_POST['storage'];
      $postedon=$_POST['postedon'];
      
      $query=mysqli_query($con,"UPDATE `reminder` SET `thingname`='$thingname',`storage`='$storage',`storedon`='$storedon',`postedon`='$postedon',`rstatus`='$rstatus' WHERE uid='$id'") or die(mysqli_error($con));
       if($query==true)
         {
