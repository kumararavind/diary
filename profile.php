        ...
        <form action="" method="post">
          <div class="row">
            <div class="col-md-4 form-group">
              <img src='images/p2.jpg' alt="No image" class="rounded-circle" width="150" height="150">
                 </div>
                ...
                <div class="row">
                  <label><strong>Name</strong></label><br>
                   <?php 
                      $qr=mysqli_query($con,"SELECT * from `user` where uid='$uid'");
                  ...
                  <div class="row">
                     <label><strong>Age</strong></label><br>
                       <?php $uid=$rows['uid'];
                          $qr=mysqli_query($con,"CALL `determinAge` ('$uid');");
                          $rows=mysqli_fetch_array($qr);
                          echo $rows[0];
                        ?>
                  </div>
         ...
         <div class="row">
          ...
          <a href="homepage.php" name="back" class="btn btn-success" style="margin-left: 1000px";>Back</a>
               </div>
                </div>
