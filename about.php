      ...
      <section class="about-inner py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
            ...
            <div class="row abt-inner-agile">
               <div class="col-lg-6 col-md-6 abt-inner-left">
                  <div class="row">
                     <div class="col-sm-4 col-4 abt-inner-w3layouts-img">
               ...
               <div class="col-lg-6 col-md-6 text-center about-inner-mid">
            ...
            <div class="row">
               <div class="col-md-6 agile-img-design-left">
                  <div class="shopping-degine">
                     <h4 class=" mb-lg-4 mb-2">Small Bite Make Joy </h4>
               ...
               <div class="col-md-6 agile-img-design-right">
                  <div class="shopping-degine">
                     <h4 class=" mb-lg-4 mb-2">Enjoy day With Pizza</h4>
                     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut Lorem ipsum dolor sit amet</p>
                     <div class="w3layouts-jewel-shop">
                        <a href="about.html">Get More</a>
                     </div>
            ...
            <div class="row text-center">
               ...
               <div class="col-lg-4 wthree-left-right upper-footer">
                  <div class="middle-mid-grid">
                     ...
                     <div class="book-here">
                        <p class="p-3">consectetur adipiscing elit, sed do eiusmod tempor incididunt Lorem ipsum dolor sit amet</p>
