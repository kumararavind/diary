...
<html lang="zxx">
   ...
   $id=$_GET['uid'];
   $query=mysqli_query($con,"SELECT * from event where uid='$id'")or die(mysqli_error($con));
    ...
    <form action="" method="POST">
      <div class="row">
         <div class="col-md-6 form-group">
            ...
            <input type="text" name="eventdate" class="form-control" placeholder="Enter Event Date" value="<?php echo $row['eventdate']; ?>">
         </div>   
         <div class="col-md-6 form-group">
            <label>Event Description</label>
            <input type="text" name="description" class="form-control" placeholder="Enter Event Description" value="<?php echo $row['description']; ?>">
         </div>
      </div>
         <div class="row">
         <div class="col-md-6 form-group">
            <label>Event venue</label>
            <input type="text" class="form-control" name="evenue" placeholder="Enter Event venue" value="<?php echo $row['evenue']; ?>">
         </div>
         <div class="col-md-6 form-group">
            <label>Posted On</label>
            <input type="text" name="postedon" class="form-control" placeholder="Enter your Contact Number" value="<?php echo $row['postedon']; ?>">
         </div>
      </div>
         <div class="row">
...
<?php
   if(isset($_POST['submit']))
   {
      ...
      $query=mysqli_query($con,"UPDATE `event` SET `etitle`='$etitle',`description`='$description',`evenue`='$evenue',`eventdate`='$eventdate',`postedon`='$postedon',`estatus`='$estatus' WHERE  uid='$id'") or die(mysqli_error($con));
       if($query==true)
         {
